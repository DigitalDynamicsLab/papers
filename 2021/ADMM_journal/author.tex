...
\makenomenclature
\setlength{\nomlabelwidth}{2cm}
\setlength{\nomitemsep}{-0.1cm} % Baseline skip between items
...
%% NOTE FOR THE TYPESETTING DEPARTMENT: IF THE NOMENCLATURE FRAME
%% CONSUMES TOO MUCH SPACE IN THE ARTICLE PAGES, YOU CAN ALSO REMOVE IT. WE ARE
%% PROPOSING IT, BUT WE CAN ALSO DO WITHOUT IT, IF WE ARE GOING OUT OF THE PAGE BUDGET. 
