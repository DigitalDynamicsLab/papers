...
plane{<0,1,0>, 0
      ...
      no_shadow   
      //finish { reflection {0.12} ambient 0  }
     } 
#end
...
light_source {
  ...
  color rgb 1.6       // light's color
  area_light
  <1.6, 0, 0> <0, 1.6, 0> // lights spread out across this distance (x * z)
  4, 4                // total number of lights in grid (4x*4z = 16 lights)
  adaptive 0          // 0,1,2,3...
  jitter              // adds random softening of light
  circular            // make the shape of the light circular
  orient              // orient light
  translate <6, 6,  4>   // <x y z> position of light
}
...
// Include shape assets (triangle meshes): 

#include "render_frames.pov.assets"

// Include POV code to for the n.th scene file: 

#declare scene_file = concat("output/state", str(frame_number,-5,0), ".pov") 
#include scene_file 
